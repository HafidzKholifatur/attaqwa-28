<?= view('dashboard/layouts/header') ?>
    ...
    <div class="container-fluid">
        <div class="">
            <!-- Page Heading -->
            <div class="row">
                <h1 class="h3 mb-4 text-gray-800 col-6">Edit Berita</h1>
                ...
                <div class="card-body">
                    <form id="beritaForm" action="/admin/berita/update/<?= $berita['id'] ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="summary" name="summary" value="<?= $berita['summary'] ?>" required>
                            <small class="text-info">Sebagai informasi highlight pada card berita.</small>
                        </div>
                        <hr>
                        <div class="form-group">
                            <label for="content">Konten</label>
                            <textarea class="form-control" id="summernote" name="content"><?= $berita['content'] ?></textarea>
                        </div>
                        <hr>
                        <div class="form-group">
                            ...
                            <select class="form-control" id="status" name="status">
                                ...
                                <option value="publish" <?= $berita['status'] == 'publish' ? 'selected' : '' ?>>Published</option>
                            </select>
                        </div>
...
<!-- End of Main Content -->
    ...
    <!-- <script>
        function deleteImage(src) {
            $.ajax({
                url: '/admin/berita/delete-image', // Ganti dengan URL yang sesuai di CI4
                method: 'POST',
                data: { src: src },
                success: function(response) {
