<?= view('dashboard/layouts/header') ?>
    ...
    <div class="container-fluid">
        <div class="col-lg-6 col-md-8">
            <!-- Page Heading -->
            <div class="row">
                <h1 class="h3 mb-4 text-gray-800 col-6">Tambah Gambar</h1>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="<?= base_url('/admin/gallery/store') ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="desc" name="desc" placeholder="Masukkan Deskripsi Singkat" required>
                        </div>
