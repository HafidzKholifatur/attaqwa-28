<?= view('dashboard/layouts/header') ?>
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <div class="row">
            <h1 class="h3 mb-4 text-gray-800 col-6">Tabel User</h1>
            <div class="col-6 d-flex justify-content-end">
                <a class="btn btn-success mb-4 col-auto" href="<?= base_url('/admin/user/create') ?>">
                            ...
                            <?php foreach ($users as $user): ?>
                                <tr data-id="<?= $user['id'] ?>">
                                    ...
                                    <td class="text-center">
                                        <a href="/admin/user/edit/<?= $user['id'] ?>" class="btn btn-primary btn-sm">
                                            <i class="fas fa-edit"></i>&nbsp;Edit
                                        </a>
                                        <a href="/admin/user/delete/<?= $user['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Menghapus User?')">
